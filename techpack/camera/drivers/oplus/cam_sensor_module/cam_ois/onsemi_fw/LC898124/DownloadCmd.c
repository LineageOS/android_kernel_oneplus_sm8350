...
#if ((((SELECT_VENDOR&0x01) == 0x01) || ((SELECT_VENDOR&0x80) == 0x80)) && (SELECT_MODEL == 0x00))				// SEMCO or Oplus
#include "LC898124EP3_Code_0_1_0_2_2_0.h"		// Gyro=LSM6DSM,	SO2823
#include "LC898124EP3_Code_0_1_0_2_2_1.h"		// Gyro=LSM6DSM,	FRA, SO2823
#endif
#if ((((SELECT_VENDOR&0x01) == 0x01) || ((SELECT_VENDOR&0x80) == 0x80)) && (SELECT_MODEL == 0x01))				// SEMCO or Oplus
...
#endif
#if ((((SELECT_VENDOR&0x01) == 0x01) || ((SELECT_VENDOR&0x80) == 0x80)) && (SELECT_MODEL == 0x03))		// QTech or OPlus
#include "LC898124EP3_Code_12_0_1_0.h"                  // OPlus ICM-42631
#include "LC898124EP3_Code_12_0_1_3.h"                  // OPlus BMI260
#endif
...
#endif
#if ((((SELECT_VENDOR&0x01) == 0x01) || ((SELECT_VENDOR&0x80) == 0x80)) && (SELECT_MODEL == 0x03))		// QTech or OPlus
 {0x0000, 1, LC898124EP3_PM_12_0_1_0, LC898124EP3_PMSize_12_0_1_0, (UINT32)((UINT32)LC898124EP3_PMCheckSum_12_0_1_0 + (UINT32)LC898124EP3_DMA_CheckSum_12_0_1_0 + (UINT32)LC898124EP3_DMB_CheckSum_12_0_1_0), LC898124EP3_DM_12_0_1_0, LC898124EP3_DMA_ByteSize_12_0_1_0 , LC898124EP3_DMB_ByteSize_12_0_1_0 },
