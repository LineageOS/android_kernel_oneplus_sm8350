...
struct touchpanel_data {
	...
	bool report_rate_switch_support;                       /*switch report rate 120-240hz*/
...
eg:incell 3320 need to disable gesture to release inter pins for lcd resume*/
	...
	int (*switch_report_rate)     (void *chip_data, int value);
	void (*get_ic_firmware_version) (void *chip_data, struct panel_info *panel_data);
