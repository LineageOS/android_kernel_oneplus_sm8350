...
#define KEY1                                                                   \
	{                                                                      \
		0x21, 0x43, 0x88, 0x2A, 0xF3, 0xE1, 0x77, 0xCC                 \
	}
#define KEY2                                                                   \
	{                                                                      \
		0x24, 0xA2, 0x76, 0x08, 0x10, 0xB3, 0x48, 0x00                 \
	}

char msg_ch[64] = { 58, 50, 42, 34, 26, 18, 10, 2,  60, 52, 44, 36, 28,
...
char key_ch[56] = { 57, 49, 41, 33, 25, 17, 9,	1,  58, 50, 42, 34, 26, 18,
		    10, 2,  59, 51, 43, 35, 27, 19, 11, 3,  60, 52, 44, 36,
		    63, 55, 47, 39, 31, 23, 15, 7,  62, 54, 46, 38, 30, 22,
		    14, 6,  61, 53, 45, 37, 29, 21, 13, 5,  28, 20, 12, 4 };

char msg_ex[48] = { 32, 1,  2,	3,  4,	5,  4,	5,  6,	7,  8,	9,
		    8,	9,  10, 11, 12, 13, 12, 13, 14, 15, 16, 17,
		    16, 17, 18, 19, 20, 21, 20, 21, 22, 23, 24, 25,
		    24, 25, 26, 27, 28, 29, 28, 29, 30, 31, 32, 1 };

char key_mov[16] = { 1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1 };

char key_cmprs[48] = { 14, 17, 11, 24, 1,  5,  3,  28, 15, 6,  21, 10,
...
char p_box[32] = { 16, 7, 20, 21, 29, 12, 28, 17, 1,  15, 23,
		   26, 5, 18, 31, 10, 2,  8,  24, 14, 32, 27,
		   3,  9, 19, 13, 30, 6,  22, 11, 4,  25 };

char last_ch[64] = { 40, 8,  48, 16, 56, 24, 64, 32, 39, 7,  47, 15, 55,
...
void get_verify_numbers(char random_num[8], char encode_num[8],
			char *encode_mark)
{
	char key1[8] = KEY1;
	char key2[8] = KEY2;
